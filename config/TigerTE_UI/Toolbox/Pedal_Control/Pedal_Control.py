...
class Pedal_Control(frmTSForm):
    def __init__(self):
        ...
        try:
            ...
            self.TSSvgImageButton4.Left = 210
            self.TSSvgImageButton4.Top = 0
            self.TSSvgImageButton4.Width = 71
            self.TSSvgImageButton4.Height = 42
            self.TSSvgImageButton4.Cursor = crArrow
            self.TSSvgImageButton4.Align = "alLeft"
            self.TSSvgImageButton4.Caption = 'Jog In'
            ...
            self.TSSvgImageButton5.Left = 281
            self.TSSvgImageButton5.Top = 0
            self.TSSvgImageButton5.Width = 70
            self.TSSvgImageButton5.Height = 42
            self.TSSvgImageButton5.Cursor = crArrow
            self.TSSvgImageButton5.Align = "alLeft"
            self.TSSvgImageButton5.Caption = 'Jog Out'
            ...
            self.svgShowFault.Left = 1035
            self.svgShowFault.Top = 0
            self.svgShowFault.Width = 72
            self.svgShowFault.Height = 42
            self.svgShowFault.Cursor = crArrow
            self.svgShowFault.Align = "alRight"
            self.svgShowFault.Caption = 'Fault'
            self.svgShowFault.TabOrder = 7
            ...
            self.svgShowPower.Left = 891
            self.svgShowPower.Top = 0
            self.svgShowPower.Width = 72
            self.svgShowPower.Height = 42
            self.svgShowPower.Cursor = crArrow
            self.svgShowPower.Align = "alRight"
            ...
            self.pnlCenter.Top = 45
            self.pnlCenter.Width = 1107
            self.pnlCenter.Height = 211
            ...
            # Create control: edtShowPedalPosition = LabeledEdit(self)
            self.edtShowPedalPosition = LabeledEdit(self)
            self.edtShowPedalPosition.Name = "edtShowPedalPosition"
            self.edtShowPedalPosition.Parent = self.pnlCenter
            self.edtShowPedalPosition.Left = 19
            self.edtShowPedalPosition.Top = 32
            self.edtShowPedalPosition.Width = 136
            self.edtShowPedalPosition.Height = 30
            self.edtShowPedalPosition.Cursor = crArrow
            self.edtShowPedalPosition.TabStop = False
            self.edtShowPedalPosition.Alignment = "taRightJustify"
            self.edtShowPedalPosition.Color = 4210752
            self.edtShowPedalPosition.EditLabel.Width = 105
            self.edtShowPedalPosition.EditLabel.Height = 15
            self.edtShowPedalPosition.EditLabel.Caption = 'Pedal Position(mm)'
            self.edtShowPedalPosition.Font.Charset = DEFAULT_CHARSET
            self.edtShowPedalPosition.Font.Color = clLime
            self.edtShowPedalPosition.Font.Height = -18
            self.edtShowPedalPosition.Font.Name = 'Consolas'
            self.edtShowPedalPosition.Font.Style = ["fsBold"]
            self.edtShowPedalPosition.NumbersOnly = True
            self.edtShowPedalPosition.ParentFont = False
            self.edtShowPedalPosition.ReadOnly = True
            self.edtShowPedalPosition.TabOrder = 0
            self.edtShowPedalPosition.Text = '10.00'
            # Create control: edtShowPedalSpeed = LabeledEdit(self)
            self.edtShowPedalSpeed = LabeledEdit(self)
            self.edtShowPedalSpeed.Name = "edtShowPedalSpeed"
            self.edtShowPedalSpeed.Parent = self.pnlCenter
            self.edtShowPedalSpeed.Left = 198
            self.edtShowPedalSpeed.Top = 32
            self.edtShowPedalSpeed.Width = 136
            self.edtShowPedalSpeed.Height = 30
            self.edtShowPedalSpeed.Cursor = crArrow
            self.edtShowPedalSpeed.TabStop = False
            self.edtShowPedalSpeed.Alignment = "taRightJustify"
            self.edtShowPedalSpeed.Color = 4210752
            self.edtShowPedalSpeed.EditLabel.Width = 104
            self.edtShowPedalSpeed.EditLabel.Height = 15
            self.edtShowPedalSpeed.EditLabel.Caption = 'Pedal Speed(mm/s)'
            self.edtShowPedalSpeed.Font.Charset = DEFAULT_CHARSET
            self.edtShowPedalSpeed.Font.Color = clLime
            self.edtShowPedalSpeed.Font.Height = -18
            self.edtShowPedalSpeed.Font.Name = 'Consolas'
            self.edtShowPedalSpeed.Font.Style = ["fsBold"]
            self.edtShowPedalSpeed.NumbersOnly = True
            self.edtShowPedalSpeed.ParentFont = False
            self.edtShowPedalSpeed.ReadOnly = True
            self.edtShowPedalSpeed.TabOrder = 1
            self.edtShowPedalSpeed.Text = '10.00'
            # Create control: edtShowMCPressure = LabeledEdit(self)
            self.edtShowMCPressure = LabeledEdit(self)
            self.edtShowMCPressure.Name = "edtShowMCPressure"
            self.edtShowMCPressure.Parent = self.pnlCenter
            self.edtShowMCPressure.Left = 378
            self.edtShowMCPressure.Top = 32
            self.edtShowMCPressure.Width = 136
            self.edtShowMCPressure.Height = 30
            self.edtShowMCPressure.Cursor = crArrow
            self.edtShowMCPressure.TabStop = False
            self.edtShowMCPressure.Alignment = "taRightJustify"
            self.edtShowMCPressure.Color = 4210752
            self.edtShowMCPressure.EditLabel.Width = 91
            self.edtShowMCPressure.EditLabel.Height = 15
            self.edtShowMCPressure.EditLabel.Caption = 'MC Pressure(bar)'
            self.edtShowMCPressure.Font.Charset = DEFAULT_CHARSET
            self.edtShowMCPressure.Font.Color = clLime
            self.edtShowMCPressure.Font.Height = -18
            self.edtShowMCPressure.Font.Name = 'Consolas'
            self.edtShowMCPressure.Font.Style = ["fsBold"]
            self.edtShowMCPressure.NumbersOnly = True
            self.edtShowMCPressure.ParentFont = False
            self.edtShowMCPressure.ReadOnly = True
            self.edtShowMCPressure.TabOrder = 2
            self.edtShowMCPressure.Text = '10.00'
            ...
            self.edtTargetForce.Parent = self.pnlCenter
            self.edtTargetForce.Left = 378
            self.edtTargetForce.Top = 110
            self.edtTargetForce.Width = 128
            ...
            self.edtTargetForce.TabOrder = 3
            self.edtTargetForce.Text = '0'
            # Create control: edtShowCalibratedForce = LabeledEdit(self)
            self.edtShowCalibratedForce = LabeledEdit(self)
            self.edtShowCalibratedForce.Name = "edtShowCalibratedForce"
            self.edtShowCalibratedForce.Parent = self.pnlCenter
            self.edtShowCalibratedForce.Left = 557
            self.edtShowCalibratedForce.Top = 32
            self.edtShowCalibratedForce.Width = 136
            self.edtShowCalibratedForce.Height = 30
            self.edtShowCalibratedForce.Cursor = crArrow
            self.edtShowCalibratedForce.TabStop = False
            self.edtShowCalibratedForce.Alignment = "taRightJustify"
            self.edtShowCalibratedForce.Color = 4210752
            self.edtShowCalibratedForce.EditLabel.Width = 103
            self.edtShowCalibratedForce.EditLabel.Height = 15
            self.edtShowCalibratedForce.EditLabel.Caption = 'Calibrated Force(N)'
            self.edtShowCalibratedForce.Font.Charset = DEFAULT_CHARSET
            self.edtShowCalibratedForce.Font.Color = clLime
            self.edtShowCalibratedForce.Font.Height = -18
            self.edtShowCalibratedForce.Font.Name = 'Consolas'
            self.edtShowCalibratedForce.Font.Style = ["fsBold"]
            self.edtShowCalibratedForce.NumbersOnly = True
            self.edtShowCalibratedForce.ParentFont = False
            self.edtShowCalibratedForce.ReadOnly = True
            self.edtShowCalibratedForce.TabOrder = 4
            self.edtShowCalibratedForce.Text = '10.00'
            ...
            self.edtTargetPosition.Parent = self.pnlCenter
            self.edtTargetPosition.Tag = 10027256
            self.edtTargetPosition.Left = 198
            self.edtTargetPosition.Top = 110
            self.edtTargetPosition.Width = 128
            ...
            self.edtTargetPosition.TabOrder = 5
            ...
            self.edtTargetSpeed.Parent = self.pnlCenter
            self.edtTargetSpeed.Tag = 10027024
            self.edtTargetSpeed.Left = 19
            self.edtTargetSpeed.Top = 110
            self.edtTargetSpeed.Width = 128
            ...
            self.edtTargetSpeed.TabOrder = 6
            ...
            self.btnGotoTargetForce.Parent = self.pnlCenter
            self.btnGotoTargetForce.Left = 378
            self.btnGotoTargetForce.Top = 160
            self.btnGotoTargetForce.Width = 134
            ...
            self.btnGotoTargetForce.TabOrder = 7
            ...
            self.btnGotoTargetPosition.Parent = self.pnlCenter
            self.btnGotoTargetPosition.Left = 198
            self.btnGotoTargetPosition.Top = 160
            ...
            self.btnGotoTargetPosition.TabOrder = 8
            # Create control: btnGoHome = Button(self)
            self.btnGoHome = Button(self)
            self.btnGoHome.Name = "btnGoHome"
            self.btnGoHome.Parent = self.pnlCenter
            self.btnGoHome.Left = 19
            self.btnGoHome.Top = 160
            ...
            self.LabeledEdit9.Left = 915
            self.LabeledEdit9.Top = 110
            self.LabeledEdit9.Width = 128
            self.LabeledEdit9.Height = 23
            self.LabeledEdit9.Cursor = crArrow
            self.LabeledEdit9.Alignment = "taRightJustify"
            ...
            self.LabeledEdit9.NumbersOnly = True
            self.LabeledEdit9.TabOrder = 10
            self.LabeledEdit9.Text = '40'
            ...
            self.edtMinPosition.Parent = self.pnlCenter
            self.edtMinPosition.Left = 736
            self.edtMinPosition.Top = 110
            self.edtMinPosition.Width = 128
            ...
            self.edtMinPosition.TabOrder = 11
            self.edtMinPosition.Text = '-10'
            # Create control: btnSetPedalRange = Button(self)
            self.btnSetPedalRange = Button(self)
            self.btnSetPedalRange.Name = "btnSetPedalRange"
            self.btnSetPedalRange.Parent = self.pnlCenter
            self.btnSetPedalRange.Left = 736
            self.btnSetPedalRange.Top = 160
            self.btnSetPedalRange.Width = 142
            ...
            self.btnSetPedalRange.TabOrder = 12
            ...
            self.edtShowErrorCode.Parent = self.pnlCenter
            self.edtShowErrorCode.Left = 915
            ...
            self.edtShowErrorCode.TabOrder = 13
            ...
            self.Panel11.Left = 1
            self.Panel11.Top = 256
            self.Panel11.Width = 1107
            self.Panel11.Height = 245
            ...
            self.btnExcuteCalibration.Parent = self.Panel11
            self.btnExcuteCalibration.Left = 852
            ...
            self.btnApplyNewPosVSPressTable.Parent = self.Panel11
            ...
            self.btnEnableForceCalibration.Parent = self.Panel11
            self.btnEnableForceCalibration.Left = 846
            ...
            self.StringGrid2.Top = 152
            self.StringGrid2.Width = 1024
            ...
            self.edtPositionVSPressureTableSize.Parent = self.Panel11
            self.edtPositionVSPressureTableSize.Left = 263
            self.edtPositionVSPressureTableSize.Top = 24
            ...
            self.edtPositionVSPressureTableSize.TabOrder = 5
            ...
            self.edtPresVSForceTableSize.Parent = self.Panel11
            self.edtPresVSForceTableSize.Left = 263
            self.edtPresVSForceTableSize.Top = 120
            ...
            self.edtPresVSForceTableSize.TabOrder = 6
